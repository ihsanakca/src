...
public class arrayList_2 {
    public static void main(String[] args) {
       ...
       // }
        ...
        System.out.println("nums = " + nums);//nums = [190, 55, 60, 200]

        nums.remove(Integer.valueOf(55));
        System.out.println("nums = " + nums);//nums = [190, 60, 200]

        nums.remove(Integer.parseInt("1"));
        System.out.println("nums = " + nums);//nums = [190, 200]
